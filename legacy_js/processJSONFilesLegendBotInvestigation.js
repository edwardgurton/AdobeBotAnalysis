...
const jsonTransformLegendBotInvestigation = require('./utils/jsonTransformLegendBotInvestigation');
...
async function processJSONFiles(folderPath, filePattern = /\.json$/, optionalFolder = '') {
    ...
    try {
        ...
        for (const jsonFile of jsonFiles) {
            ...
            try {
                // Transform JSON file
                const result = jsonTransformLegendBotInvestigation(jsonFilePath);
