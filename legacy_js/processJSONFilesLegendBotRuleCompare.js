...
const jsonTransformBotRuleCompare = require('./utils/jsonTransformBotRuleCompare');
...
try {
    ...
    for (const jsonFile of jsonFiles) {
        ...
        try {
            // Transform JSON file using bot rule compare transformer
            const result = jsonTransformBotRuleCompare(jsonFilePath);
